...
app.use('/api/suppliers', authMiddleware.requireAuth, supplierRoutes);
app.use('/api/products', authMiddleware.requireAuth, productRoutes);
app.use('/api/orders', authMiddleware.requireAuth, orderRoutes);
app.use('/api/alerts', authMiddleware.requireAuth, alertRoutes);
app.use('/api/price-compare', authMiddleware.requireAuth, priceCompareRoutes);
